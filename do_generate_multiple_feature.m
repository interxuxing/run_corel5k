...
%% 1 step   
    ...
    if feature_scale == 1
        ...
        [train_samples.denseHUE, train_sample.alpha_denseHUE] = scalefeature(double(vec_read(feature_file)), 1, 0);
    end
    ...
    if feature_scale == 1
        ...
        [train_samples.denseSIFT, train_samples.alpha_denseSIFT] = scalefeature(double(vec_read(feature_file)), 1, 0);
    end
    ...
    if feature_scale == 1
        ...
        [train_samples.GIST, train_samples.alpha_GIST] = scalefeature(double(vec_read(feature_file)), 1, 0);
    end
    ...
    if feature_scale == 1
        ...
        [train_samples.HSV, train_samples.alpha_HSV] = scalefeature(double(vec_read(feature_file)), 1, 0);
    end
    ...
    if feature_scale == 1
        ...
        [train_samples.LAB, train_samples.alpha_LAB] = scalefeature(double(vec_read(feature_file)), 1, 0);
    end
    ...
    if feature_scale == 1
        ...
        [train_samples.RGB, train_samples.alpha_RGB] = scalefeature(double(vec_read(feature_file)), 1, 0);
    end
...
%% 3 step
    ...
    if feature_scale == 1
        ...
        [test_samples.denseHUE, test_samples.alpha_denseHUE] = scalefeature(double(vec_read(feature_file)), 1, 0);
    end
    ...
    if feature_scale == 1
        ...
        [test_samples.denseSIFT, test_samples.alpha_denseSIFT] = scalefeature(double(vec_read(feature_file)), 1, 0);
    end
    ...
    if feature_scale == 1
        ...
        [test_samples.GIST, test_samples.alpha_GIST] = scalefeature(double(vec_read(feature_file)), 1, 0);
    end
    ...
    if feature_scale == 1
        ...
        [test_samples.HSV, test_samples.alpha_HSV] = scalefeature(double(vec_read(feature_file)), 1, 0);
    end
    ...
    if feature_scale == 1
        ...
        [test_samples.LAB, test_samples.alpha_LAB] = scalefeature(double(vec_read(feature_file)), 1, 0);
    end
    ...
    if feature_scale == 1
        ...
        [test_samples.RGB, test_samples.alpha_RGB] = scalefeature(double(vec_read(feature_file)), 1, 0);
    end
